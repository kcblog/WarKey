...
Global $hGUI          = GUICreate("WarKey v" & $version, 180, 182, -1, -1, $WS_SYSMENU)
...
; Create Labels
Global $lblNumpad7    = GUICtrlCreateLabel("Num 7:", 10, 12)
Global $lblNumpad8    = GUICtrlCreateLabel("Num 8:", 95, 12)
Global $lblNumpad4    = GUICtrlCreateLabel("Num 4:", 10, 34)
Global $lblNumpad5    = GUICtrlCreateLabel("Num 5:", 95, 34)
Global $lblNumpad1    = GUICtrlCreateLabel("Num 1:", 10, 56)
Global $lblNumpad2    = GUICtrlCreateLabel("Num 2:", 95, 56)

; Create Input Fields
Global $txtNumpad7    = GUICtrlCreateInput("w", 50, 9, 28, -1, BitOR($ES_CENTER, $ES_LOWERCASE))
GUICtrlSetLimit($txtNumpad7, 1)
Global $txtNumpad8    = GUICtrlCreateInput("e", 135, 9, 28, -1, BitOR($ES_CENTER, $ES_LOWERCASE))
GUICtrlSetLimit($txtNumpad8, 1)
Global $txtNumpad4    = GUICtrlCreateInput("s", 50, 31, 28, -1, BitOR($ES_CENTER, $ES_LOWERCASE))
GUICtrlSetLimit($txtNumpad4, 1)
Global $txtNumpad5    = GUICtrlCreateInput("d", 135, 31, 28, -1, BitOR($ES_CENTER, $ES_LOWERCASE))
GUICtrlSetLimit($txtNumpad5, 1)
Global $txtNumpad1    = GUICtrlCreateInput("x", 50, 53, 28, -1, BitOR($ES_CENTER, $ES_LOWERCASE))
GUICtrlSetLimit($txtNumpad1, 1)
Global $txtNumpad2    = GUICtrlCreateInput("c", 135, 53, 28, -1, BitOR($ES_CENTER, $ES_LOWERCASE))
...
; Create Buttons
Global $btnActivate   = GUICtrlCreateButton("&Activate {Pause}", 20, 78, 134)
GUICtrlSetState($btnActivate, $GUI_FOCUS)
Global $btnDeactivate = GUICtrlCreateButton("&Deactivate {Pause}", 20, 78, 134)
  ...
  ; If (WinGetTitle("Warcraft III") <> "This Gui Title" AND $running) Then
    Select
      ...
      Case $msg = $mnuHelpCheck
        ...
        $bData = StringTrimRight(InetRead("http://warkey.echin.net/warkey-lite.ver?" & TimerInit()), 2)
